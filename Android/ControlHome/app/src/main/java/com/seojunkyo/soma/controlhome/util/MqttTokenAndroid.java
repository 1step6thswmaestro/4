...
class MqttTokenAndroid implements IMqttToken {
   ...
   */
  MqttTokenAndroid(IMqttAsyncClient client,
  ...
  /**
   * @see org.eclipse.paho.client.mqttv3.IMqttToken#setActionCallback(org.eclipse.paho.client.mqttv3.IMqttActionListener)
   */
  @Override
