...
public class AddressListAdapter extends BaseAdapter {
    ...
    ArrayList<AddressList> datas;
    LayoutInflater inflater;

    public AddressListAdapter(LayoutInflater inflater, ArrayList<AddressList> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView reminder_contents= (TextView)convertView.findViewById(R.id.listitem_address);

        //현재 position( getView()메소드의 첫번재 파라미터 )번째의 Data를 위 해당 View들에 연결..
        reminder_contents.setText( datas.get(position).getSpace());
